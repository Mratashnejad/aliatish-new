...
export default function Term() {
    return (
        <section
            id="terms-of-service"
            className="w-full min-h-screen py-28 px-6 bg-gray-50 dark:bg-gray-900"
        >
            <div className="container mx-auto text-center">
                ...
                <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
                    <p className="text-gray-700 dark:text-gray-300 mb-6">
                        Welcome to [Ali Atish]. By using our services, you agree to the following terms and conditions. Please read them carefully.
                    </p>
