...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white text-gray-900">
      <h1 className="text-3xl font-bold text-center mb-6">Privacy Policy for Aliatish.com</h1>
      ...
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-blue-600">3. Sharing Your Information</h2>
          <p className="text-gray-700">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-blue-600">4. Data Security</h2>
          <p className="text-gray-700">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-blue-600">5. Your Rights</h2>
          <p className="text-gray-700">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-blue-600">6. Third-Party Links</h2>
          <p className="text-gray-700">
