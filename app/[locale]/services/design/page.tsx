                        ...
                        <motion.div variants={itemVariants}>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-gray-300 mb-6">
                                            The Basic Design package is perfect
                                            for personal projects or startups.
                                            It includes simple user interface
                                            design, wireframes, and prototyping.
                                            Ideal for those looking to create a
                                            sleek and functional design on a
                                            budget.
                                        </p>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-gray-300 mb-6">
                                            ...
                                            businesses that need more complex
                                ...
                                <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                                    ...
                                    >
                                        ...
                                        <p className="text-lg text-gray-300 mb-6">
                                            ...
                                            small projects looking for basic but
                                    ...
                                    >
                                        ...
                                        <p className="text-lg text-gray-300 mb-6">
                                            For businesses needing custom
                                            branding, UI/UX design, and fully
                                            responsive websites.
                                        </p>
                                        <ul className="list-disc pl-6 text-lg text-gray-300 space-y-3 mb-6">
                                    ...
                                    >
                                        ...
                                        <p className="text-lg text-gray-300 mb-6">
                                            The ultimate design package for
                                            brands and businesses seeking a
                                            top-tier digital presence.
                                        </p>
                                        <ul className="list-disc pl-6 text-lg text-gray-300 space-y-3 mb-6">
                                            <li>Full Branding</li>
                            ...
                            >
                                ...
                                <p className="text-lg text-gray-800 dark:text-gray-300 mb-4">
                                    Each design package can be customized based
