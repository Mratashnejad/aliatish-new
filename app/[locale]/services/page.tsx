                    ...
                    >
                        <div className="lg:w-2/3 lg:pr-8">
                            ...
                            <p className="text-gray-700 dark:text-gray-400 mb-6">
                                Software as a Service (SaaS) is a business model whereby the user pays a subscription to access cloud-based services or an application.</p>
                            <p className="text-gray-700 dark:text-gray-400 mb-4">
                                SaaS Web Apps: Built with Next.js and More
                            </p>
                            <p className="text-gray-700 dark:text-gray-400 mb-4">
                            I create fast and reliable web apps using Next.js, a popular React framework. I use databases like PostgreSQL and MongoDB to store your data. I design user-friendly interfaces with Tailwind CSS to make your app easy to use.                            </p>
                        </div>
