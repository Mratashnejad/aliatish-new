...
import { useAnimate, Target } from "framer-motion";

const LinksSectionPage: React.FC = () => {
  return (
...
const LinkBox: React.FC<LinkBoxProps> = ({ Icon, href }) => {
  ...
  const getNearestSide = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>): string => {
  ...
  const handleMouseEnter = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    ...
    animate(scope.current as Target, {
...
export default LinksSectionPage;