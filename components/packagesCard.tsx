...
const SquishyCard: React.FC<SquishyCardProps> = ({ title, price, description, buttonText }) => {
  return (
    <section className="bg-neutral-900 px-4 py-12">
      <div className="mx-auto w-fit">
        <Card title={title} price={price} description={description} buttonText={buttonText} />
      </div>
    </section>
  );
};

const Card: React.FC<SquishyCardProps> = ({ title, price, description, buttonText }) => {
  return (
    <motion.div
      whileHover="hover"
      transition={{
