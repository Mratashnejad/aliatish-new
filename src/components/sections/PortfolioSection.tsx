    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full opacity-10">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <path fill="#FF0066" d="M47.5,-61.5C60.2,-53.9,68.5,-37.5,73.1,-20.1C77.7,-2.7,78.5,15.7,71.8,30.8C65.1,45.9,50.8,57.7,35.2,63.9C19.6,70.1,2.7,70.6,-15.4,68.1C-33.5,65.6,-52.8,60.2,-63.2,47.8C-73.6,35.4,-75.1,15.9,-73.3,-2.8C-71.5,-21.5,-66.5,-39.5,-54.9,-47.8C-43.3,-56.1,-25.1,-54.7,-7.8,-54.9C9.6,-55,29.1,-56.8,47.5,-61.5Z" transform="translate(100 100)" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-white/80 mb-6">
            Exceptional Projects That Inspire
          </p>
          <p className="text-lg text-white/70">
            Explore our portfolio of award-winning digital solutions that showcase our commitment to innovation, performance, and exceptional user experience.
          </p>
        </motion.div>
